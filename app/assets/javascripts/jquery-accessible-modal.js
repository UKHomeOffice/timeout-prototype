jQuery(document).ready(function($) {
    ...
    $body.on('click', '.js-modal', function(event) {
        var $this = $(this),
            ...
            $modal_close_text = options.modalCloseText || 'Continue my current session',
            $modal_close_route = options.modalCloseRoute || '',
        ...
        $modal_code += '<div class="modal-button-wrapper">';
        $modal_code += '<div class="modal-button"> <button type="button" id="js-modal-close" data-module="govuk-button" class="' + $modal_prefix_classes + 'modal-close govuk-button" data-content-back-id="' + modal_content_id + '" data-focus-back="' + $modal_starter_id + '" title="' + $modal_close_title + '">';
        if ($modal_close_img !== '') {
